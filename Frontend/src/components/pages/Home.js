...
const Home = () => {
  const cardsData = [
    ...
    { id: 2, gifUrl: 'https://images.freeimages.com/image/previews/a1a/study-kit-flat-png-design-5690859.png', heading: 'Reasoning', linkTo: '/card2' },
    { id: 3, gifUrl: 'https://img.freepik.com/free-vector/hand-drawn-life-coaching-illustration_23-2150257296.jpg?t=st=1713808635~exp=1713812235~hmac=8999a03ddd917402bbdeab6385e036687901bd5e941e64290e5bd597bdb5e334&w=740', heading: 'Verbal', linkTo: '/card2' },
